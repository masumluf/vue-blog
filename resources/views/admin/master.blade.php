...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/bower_components/admin-lte/plugins/fontawesome-free/css/all.css">
  <!-- Ionicons -->
...
<div class="wrapper" id="app">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link to="/contact" class="nav-link"><i class="far fa-circle nav-icon"></i>Contact</router-link>

              </li>
              <li class="nav-item">
                <router-link to="/table" class="nav-link"><i class="far fa-circle nav-icon"></i>Table</router-link>

              </li>

              <li class="nav-item">
                <router-link to="/posts" class="nav-link"><i class="nav-icon fas fa-th"></i>Posts</router-link>
  ...
  <footer class="main-footer">
    ...
    <strong>OurSchool</strong> All rights
    reserved.
  </footer>
